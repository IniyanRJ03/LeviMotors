    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 320, maxWidth: 700, color: '#fff', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start' }}>
          <motion.h1 variants={fadeUp} style={{ fontSize: '2.8rem', fontWeight: 900, marginBottom: 18, letterSpacing: '-1px' }}>Contact Levi Motors</motion.h1>
          <motion.p variants={fadeUp} style={{ fontSize: '1.18rem', color: '#fff', maxWidth: 540, fontWeight: 400, marginBottom: 0 }}>
            Get in touch with our friendly team for bookings, quotes, or any questions. We're here to help you with all your car repair and servicing needs in Gravesend and beyond.
          </motion.p>
        </div>
        {/* Right: Image */}
        <motion.div
