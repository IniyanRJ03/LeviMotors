    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 320, maxWidth: 700, color: '#fff', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start' }}>
          <motion.h1 variants={fadeUp} style={{ fontSize: '2.8rem', fontWeight: 900, marginBottom: 18, letterSpacing: '-1px' }}>Our Services</motion.h1>
          <motion.p variants={fadeUp} style={{ fontSize: '1.18rem', color: '#fff', maxWidth: 540, fontWeight: 400, marginBottom: 0 }}>
            Car repairs, servicing, diagnostics, and MOTs—all under one roof at 56 London Road, Northfleet, Gravesend, DA11 9LF.
          </motion.p>
        </div>
        {/* Right: Image */}
        <motion.div
